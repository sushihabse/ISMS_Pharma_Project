    ...
    <div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 d-print-none">
            ...
            <div class="container class="bg-light">
                        <div class="col-4"></div>
                        <div class="col-4 mx-auto  bg-success w-100">
                            <p class="fs-3  text-center text-light" style="background-color:#121642">Purchase Reports</p>
                        </div>
                        <hr style="color:red;">
                ...
                <script>
                    ...
                    changeYear: true,
                     ...
                     <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                      ...
                      <button type="submit" name="search" class="text-light" style="background-color:#121642" >
                      Search</button>
                    </form>
                 ...
                 <table class="text-center w-100">
                    ...
                    <tbody>
                        <?php 
                         ...
                         $sql1="SELECT medicine.medicine_id,medicine.medicine_name,medicine.unit_price,medicine_stock.stock_in_date,medicine_stock.purchase_qty,medicine_stock.purchase_price,supplier.supplier_name from medicine_stock left join medicine on medicine_stock.medicine_id=medicine.medicine_id left join supplier on medicine_stock.supplier_id=supplier.supplier_id where stock_in_date BETWEEN  '$start_date' AND '$end_date'";
