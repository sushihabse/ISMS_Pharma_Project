...
if(isset($_POST['save'])){
    ...
    $phone=$_POST['custophone'];
    $email=$_POST['custoemail'];
    $address=$_POST['address'];
    $toc=$_POST['typecustomer'];

    $sql="call insertCust('$customer_name','$phone','$email','$address','$toc')";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            ...
            <div class="container">
                        ...
                        <p class="fs-3 text-center w-100 text-light" style="background-color:#121642">Add New Customar</p>
                        <form  action="#" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                    <label for="cuspname" class="form-label">Customer Name:</label>
                        <input type="text" class="form-control" name="cuspname">
                ...
                <label for="custoemail" class="form-label">Email:</label>
                        <input type="email" class="form-control" name="custoemail">
                ...
                <a href="customer_manage.php" type="button" class="btn btn-success mt-3" style="background-color:#121642">Show Customer</a>
                </form>
        <hr style="color:red;">
