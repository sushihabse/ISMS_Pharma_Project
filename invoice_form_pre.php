<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql=("insert into invoice(customer_id,invoice_date,sales_type,medicine_id,packing_unit,dis_percent,dis_amount,sub_total,Due,Paid,Grand_total)values($cust_id,'$invoiceD','$salesT',$medi_id,'$packingU',$disP,$disA,$subT,$due,$paid,$grand_total)");
