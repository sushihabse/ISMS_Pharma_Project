...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            ...
            <div class="h3 text-light  text-center w-100" style="background-color:#121642">Show Supplier</div>
            <div class="mb-2">
                <a href="add_supplier.php" class="btn btn-success btn-sm active"  role="button" aria-pressed="true"><i class="fa-solid fa-plus fa-2x style="background-color:#121642" ></i></a>
            </div>
  ...
  <tbody>
      ...
      if($query1){
          while( $row=mysqli_fetch_assoc($query1)){
            ...
            <td>
                <button class="btn btn-danger float-end"><a href="manage_supplier.php?did='.$id.'" class="text-light"><i class="fa fa-trash"></i></a></button>
                <button class="btn btn-success float-end me-3"><a href="update_supplier.php?uid='.$id.'" class="text-light"> <i class="fa-solid fa-pen-to-square"></i></a></button>
            </td>
          </tr>';
          }
      };
