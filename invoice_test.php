<?php
    ...
    if(isset($_POST['submit'])){
        ...
        foreach($medi_id as $key=>$medicine_id){
            $medi_id=$medi_id[$key];
            $issuQ=$issueQ[$key];
            $packingU=$packingU[$key];
            $balanceQ=$balanceQ[$key];
            $total=$total[$key];
            $sql=("insert into invoice(customer_id,invoice_date,sales_type,medicine_id,packing_unit,dis_percent,dis_amount,total,sub_total,Due,Paid,Grand_total)values($cust_id,'$invoiceD','$salesT',$medi_id,'$packingU',$disP,$disA,$total,$subT,$due,$paid,$grand_total)");
            $query=mysqli_multi_query($conn,$sql);
            $sql1=("update medicine_stock set issue_qty=$issueQ,balance_qty=$balanceQ where medicine_id=$medi_id");
            $query1=mysqli_multi_query($conn,$sql1);
            if($query){
    ...
    <div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            ...
            <div class="container">
                        ...
                        <p class="fs-3 text-center bg-success text-light">Create Invoice</p>
        				<hr style="color:red;">
        <?php $p=0;?>				
		    ...
		    <input type="hidden" name="rowlen" id="rowlen"  value="<?php echo $p+1?>"/>
				...
				<div class="row invoice_item" id="add_field">
									...
									<div class="col-2">
									    ...
									    <input type="text" id="balanceQ<?php echo $p+1?>"  class="form-control" name="balanceQ[]" onkeyup="qty()" readonly="readonly">
									  </div>
									<div  class="col-1">
                ...
                $('#add2').click(function () {
                    ...
                    result+='<div class="col-2"><input type="text" id="balanceQ'+r+'"  class="form-control" name="balanceQ[]" onkeyup="mycal('+r+')" readonly="readonly"></div>'
                    ...
                    result+='<div class="col-2"><input type="text"  class="form-control totCount" id="total'+r+'" name="total[]" value="" readonly="readonly" ></div>'
