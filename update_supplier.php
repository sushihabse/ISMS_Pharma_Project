...
$id=$_GET['uid'];
  ...
  $suppN=$row['supplier_name'];
  $phn=$row['supplier_phone'];
  $email=$row['supplier_email'];
  $addr=$row['address'];
  $suppType=$row['type_of_supplier'];
if(isset($_POST['save'])){
    ...
    $sql="update supplier set supplier_name='$Supplier_name',supplier_phone=$phone,supplier_email='$email',address='$addres',type_of_supplier='$tos' where supplier_id=$id";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            ...
            <div class="container">
                        ...
                        <p class="fs-4 text-center bg-success text-light">Add New Supplier</p>
                        <hr style="color:red;">
                ...
                <label for="suppphone" class="form-label" >Phone Number:</label>
                        <input type="number" class="form-control" name="suppphone" value="<?php echo $phn; ?>">
                       
                <div class="mb-3">
                <label for="suppemail" class="form-label">Email:</label>
                        <input type="email" class="form-control" name="suppemail"  value="<?php echo $email; ?>">
                        
                </div>
                <div class="mb-3">
                        <label for="address" class="form-label" >Address:</label>
                        <input type="text" class="form-control" name="address1" value="<?php echo $addr; ?>">
                 </div>
                 <div class="mb-3">
                ...
                <a href="manage_supplier.php" type="button" class="btn btn-success mt-3">Show Suppplier</a>
                </form>
