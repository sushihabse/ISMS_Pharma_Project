...
$id=$_GET['uid'];
  ...
  $custEmail=$row['email'];
  $custAdd=$row['address'];
  $cusType=$row['type_of_customer'];
if(isset($_POST['save'])){
    $customer_name=$_POST['cuspname'];
    $phn=$_POST['custophone'];
    $Email=$_POST['custoemail'];
    $addr=$_POST['address'];
    $toc=$_POST['typecustomer'];
    $sql="update customer set customer_name='$customer_name',phone=$phn,email='$Email',address='$addr',type_of_customer='$toc' where customer_id=$id";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            ...
            <div class="container">
                        ...
                        <p class="fs-3 text-center bg-success w-100 text-light">Add New Customar</p>
                        <form  action="#" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                    <label for="cuspname" class="form-label">Customer Name:</label>
                        <input type="text" class="form-control" name="cuspname" value="<?php echo $customerN1; ?>">
                        
                </div>
                <div class="mb-3">
                <label for="custophone" class="form-label">Phone Number:</label>
                        <input type="number" class="form-control" name="custophone" value="<?php echo $contactN1; ?>">
                       
                <div class="mb-3">
                <label for="custoemail" class="form-label">Email:</label>
                        <input type="email" class="form-control" name="custoemail" value="<?php echo $custEmail; ?>">
                        
                </div>
                <div class="mb-3">
                        <label for="address" class="form-label">Address:</label>
                        <input type="text" class="form-control" name="address" value="<?php echo $custAdd; ?>">
                 </div>
                 <div class="mb-3">
                    <label for="typecustomer" class="form-label">Type of Customer:</label>
                        <select class="form-control" name="typecustomer" value="<?php echo $cusType; ?>">
                        <option value="">Please Select Type of Customer</option>
			            <option >Local </option>
                ...
                <button type="submit" class="btn btn-primary mt-3" name="save">Update</button>
                <a href="customer_manage.php" type="button" class="btn btn-success mt-3">Show Customer</a>
                </form>
        <hr style="color:red;">
